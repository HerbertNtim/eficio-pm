...
const Task = ({ task }: TaskProp) => {
  ...
  const PriorityTags = ({ priority }: { priority: TaskType["priority"] }) => (
    <div
      className={`rounded-lg px-3 py-1 text-xs font-semibold ${priority === "Urgent" ? "bg-red-200 text-red-700" : priority === "High" ? "bg-yellow-200 text-yellow-700" : priority === "Medium" ? "bg-green-200 text-green-700" : priority === "Low" ? "bg-blue-200 text-blue-700" : "bg-gray-200 text-gray-700"}`}
    >
      {priority}
    </div>
  );
  ...
  return (
    ...
    >
      ...
      {task.attachments && task.attachments.length > 0 && (
        <Image
          src={`https://eficio-pm-s3-images.s3.us-east-1.amazonaws.com/${task.attachments[0].fileURL}`}
      ...
      <div className="p-4 md:p-6">
        ...
        <div className="my-3 flex justify-between">
          <h4 className="text-md font-black dark:text-white">{task.title}</h4>
          ...
          <div className="flex -space-x-[6px] overflow-hidden">
            {task.assignee && (
              <Image
                ...
                src={`https://eficio-pm-s3-images.s3.us-east-1.amazonaws.com/${task.assignee.profilePictureUrl!}`}
            ...
            {task.author && (
              <Image
                ...
                src={`https://eficio-pm-s3-images.s3.us-east-1.amazonaws.com/${task.author.profilePictureUrl!}`}
